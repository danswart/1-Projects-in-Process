...
library(dplyr) # A Grammar of Data Manipulation - make pipe available
...
ggplot2::ggplot(data_long, 
  ...
  ggplot2::scale_color_manual(values = c('#0072B2', '#D55E00', '#009E73', "#CC79A7")) +
                    #  "#E69F00" "#0072B2"  "#D55E00"  "#009E73"  "#CC79A7" "#F0E442" "#999999" "#000000" "#56B4E9" )

  ggplot2::scale_x_discrete(breaks = unique(data$survey_period)) +  # Use unique values from the x column
